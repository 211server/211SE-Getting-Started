...
![我们的手无寸铁的飞船. 黑色的挂载点是武器将要装备的地方.](<../.gitbook/assets/image (5).png>)
...
使你的武器开火的最简单的方式类似于旧的从"方块武器"区添加火炮到工具栏的方法. 使用武器核心, 你可以同时发射多种类型不同的武器. 这是通过为每个组切换"鼠标射击"设置来实现的. 简单地拖动你希望手动开火的组到工具栏然后为每个武器选择"切换鼠标射击"(Toggle Mouse Shoot)选项. 你可以随意地再次关闭它. 对于每一个开启了此选项的武器, 当你在你的船里点击鼠标左键, 这些武器就会开火.
